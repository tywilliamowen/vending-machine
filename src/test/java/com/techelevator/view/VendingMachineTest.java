...
public class VendingMachineTest {
	...
	@Test
	public void successful_purchase() throws IOException {
	...
	@Test
	public void purchase_item_greater_than_current_balance() throws IOException {
		vendingMachineTest.feedMoney(1);
		Assert.assertEquals("Please Insert Additional Funds", vendingMachineTest.purchaseItem("B1"));
	}

	@Test
	public void item_debits_correct_amount() throws IOException {
		vendingMachineTest.feedMoney(2);
...
//		}
	...
	@Test
	public void item_out_of_stock() throws IOException {
